  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader className="space-y-4 text-center">
        ...
        <CardDescription className="text-lg">Sign in to your college portal account</CardDescription>
      </CardHeader>
        ...
        <form action={formAction} className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="email" name="email" type="email" placeholder="student@college.edu" required className="h-12" />
            </div>
            <div className="space-y-2">
